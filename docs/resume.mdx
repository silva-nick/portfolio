...
_**Duke Kunshan University**_	(2023-5)  
...
**DKU Challenge Website** | _JavaScript, React, Node, REST_
...
**Duke Applied Machine Learning Group** (August 2020 - Present) 
...
**Duke Athletics** (January 2021.1 - Present)   
_**Academic Tutor: CS250, Computer Architecture**_

- Tutored 8 students in one of the 4 largest classes at Duke Spring 2021

**Duke Cyber Team** (August 2020 - May 2021)    
_**Technical Branch**_

- Learned hacking / cybersecurity techniques (Nmap, Wireshark) for CTF competitions
- Duke Cyber Cup: Placed in the top 4 out of 14 teams
