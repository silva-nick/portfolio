...
To get started with a plugin, you need to find a data source you're interested in. This could be an API or some data you require the user's to source locally.
