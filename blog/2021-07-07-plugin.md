...
Our next big step in developing our plugin is satisfying the Docusaurus lifecycle APIs. These functions
...
One of the main functions of a plugin to load / fetch data and then use that data to generate some aspect of your documentation site.
...
- **`getThemePath`:** This function is about
- **`validateThemeConfig`:**
- **`GetSwizzleComponentsList`:**
